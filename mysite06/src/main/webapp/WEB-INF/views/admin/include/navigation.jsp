				...
				<ul>
					<c:choose>
						<c:when test="${param.menu == 'main' }">
							<li class="selected"><a href="${pageContext.request.contextPath }/admin/main/1">메인페이지 관리</a></li>
						...
						<c:when test="${param.menu == 'guestbook' }">
							<li><a href="${pageContext.request.contextPath }/admin/main/1">메인페이지 관리</a></li>
